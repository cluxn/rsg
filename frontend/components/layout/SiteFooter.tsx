...
export function SiteFooter({ address, phone, email }: SiteFooterProps) {
  const displayAddress = address || '53-A, Industrial Estate, Dada Nagar, Kanpur, UP 208022';
  const displayPhone   = phone   || '+91-8047307838';
      ...
      <div className="py-10">
        <div className="mx-auto max-w-container px-5 sm:px-10 md:px-16 lg:px-24 xl:px-32 grid sm:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <address className="not-italic flex flex-col gap-3">
            ...
            <p className="font-body text-white/70 text-base flex gap-2">
            ...
            <p className="font-body text-white/70 text-base flex gap-2 items-center">
