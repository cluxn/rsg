...
const CartCheckIcon = () => (
  <svg viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10">
    ...
    <path d="M10 16h4l5 18h22l4-14H17" stroke="#C23E00" strokeWidth="1" strokeLinecap="round" opacity="0.3" />
    {/* cart body */}
    <path d="M8 14h5l5.5 20H40l4.5-15H18" stroke="#F04F00" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
    {/* wheels */}
    <circle cx="22" cy="38" r="3" stroke="#F04F00" strokeWidth="2" fill="#ffd9b8" />
    <circle cx="38" cy="38" r="3" stroke="#F04F00" strokeWidth="2" fill="#ffd9b8" />
    {/* handle */}
    <path d="M8 14H5" stroke="#F04F00" strokeWidth="2.2" strokeLinecap="round" />
    {/* checkmark badge */}
    <circle cx="42" cy="16" r="8" fill="#F04F00" />
    ...
    <path d="M20 25h18M21 29h16" stroke="#F04F00" strokeWidth="1.2" strokeLinecap="round" opacity="0.5" />
    <defs>
      <linearGradient id="cg" x1="34" y1="8" x2="50" y2="24" gradientUnits="userSpaceOnUse">
        <stop stopColor="#FFA820" />
        <stop offset="1" stopColor="#C23E00" />
      </linearGradient>
    </defs>
  </svg>
);
...
const StarReviewIcon = () => (
  <svg viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10">
    {/* back bubble (depth) */}
    <rect x="18" y="10" width="26" height="18" rx="5" fill="#ffd9b8" opacity="0.5" />
    {/* main chat bubble */}
    <rect x="8" y="8" width="34" height="22" rx="6" fill="url(#bg1)" stroke="#F04F00" strokeWidth="1.5" />
    {/* bubble tail */}
    <path d="M14 30l-4 6 8-3" fill="#F04F00" opacity="0.8" />
    {/* dots */}
    <circle cx="19" cy="19" r="2.5" fill="#F04F00" />
    <circle cx="28" cy="19" r="2.5" fill="#F04F00" />
    <circle cx="37" cy="19" r="2.5" fill="#F04F00" />
    {/* stars row */}
    {[10, 18, 26, 34, 42].map((x, i) => (
      <path key={i} d={`M${x} 41 l1.5-3 1.5 3h3.2l-2.6 2 1 3.2-3.1-2-3.1 2 1-3.2-2.6-2z`}
        fill={i < 4 ? '#F04F00' : '#ffd9b8'} stroke="#F04F00" strokeWidth="0.4" />
    ))}
    <defs>
...
const PanUpShippingIcon = () => (
  <svg viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10">
    {/* globe shadow */}
    <circle cx="24" cy="24" r="15" fill="#ffd9b8" opacity="0.4" />
    {/* globe */}
    <circle cx="24" cy="24" r="14" stroke="#F04F00" strokeWidth="2" fill="url(#gg)" />
    {/* latitude lines */}
    <ellipse cx="24" cy="24" rx="7" ry="14" stroke="#F04F00" strokeWidth="1.5" opacity="0.6" />
    <path d="M10 24h28M12 17h24M12 31h24" stroke="#F04F00" strokeWidth="1.2" opacity="0.5" />
    {/* location pin */}
    <circle cx="38" cy="14" r="5" fill="url(#pg)" stroke="#C23E00" strokeWidth="1" />
    <path d="M38 19v4" stroke="#C23E00" strokeWidth="1.5" strokeLinecap="round" />
    <circle cx="38" cy="14" r="2" fill="white" opacity="0.8" />
    {/* package bottom-right */}
    <rect x="34" y="36" width="14" height="12" rx="2" fill="url(#bx)" stroke="#F04F00" strokeWidth="1.5" />
    <path d="M34 40h14M41 36v12" stroke="#F04F00" strokeWidth="1.2" />
    <defs>
...
const HeadsetSupportIcon = () => (
  <svg viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10">
    {/* person head */}
    <circle cx="28" cy="14" r="8" fill="url(#hg)" stroke="#F04F00" strokeWidth="1.5" />
    {/* shoulders */}
    <path d="M14 36c0-7.732 6.268-14 14-14s14 6.268 14 14" stroke="#F04F00" strokeWidth="2" strokeLinecap="round" />
    {/* headset arc */}
    <path d="M16 26a12 12 0 0124 0" stroke="#F04F00" strokeWidth="2.2" strokeLinecap="round" fill="none" />
    {/* left ear cup */}
    <rect x="12" y="26" width="6" height="10" rx="3" fill="url(#eg)" stroke="#C23E00" strokeWidth="1.2" />
    {/* right ear cup */}
    <rect x="38" y="26" width="6" height="10" rx="3" fill="url(#eg)" stroke="#C23E00" strokeWidth="1.2" />
    {/* mic arm */}
    <path d="M44 34 q4 2 2 8" stroke="#F04F00" strokeWidth="1.8" strokeLinecap="round" fill="none" />
    <circle cx="46" cy="42" r="2" fill="#F04F00" />
    <defs>
...
function StatCard({ icon, topLine, bottomLine }: StatCardProps) {
  return (
    <div className="flex items-center gap-5">
      ...
      <div className="w-20 h-20 rounded-full bg-orange/10 border-2 border-orange/25 flex items-center justify-center flex-shrink-0 shadow-lg">
        {icon}
      </div>
      {/* text block */}
